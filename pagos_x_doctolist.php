...
<?php if (($pagos_x_docto->Export == "") || (EW_EXPORT_MASTER_RECORD && $pagos_x_docto->Export == "print")) { ?>
    ...
    if ($pagos_x_docto_list->DbMasterFilter <> "" && $pagos_x_docto->getCurrentMasterTable() == "historial_pagos") {
        if ($pagos_x_docto_list->MasterRecordExists) {
            ...
            <?php if ($pagos_x_docto->Export == "") { ?>
                <p class="phpmaker"><a
                            href="<?php echo $gsMasterReturnUrl ?>"><?php echo $Language->Phrase("BackToMasterPage") ?></a>
                </p>
            <?php } ?>
...
<p class="phpmaker ewTitle"
   style="white-space: nowrap;"><?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $pagos_x_docto->TableCaption() ?>
...
<?php if ($Security->CanSearch()) { ?>
    <?php if ($pagos_x_docto->Export == "" && $pagos_x_docto->CurrentAction == "") { ?>
        <a href="javascript:ew_ToggleSearchPanel(pagos_x_docto_list);" style="text-decoration: none;"><img
                    id="pagos_x_docto_list_SearchImage" src="phpimages/collapse.gif" alt="" width="9" height="9"
                    border="0"></a><span class="phpmaker">&nbsp;<?php echo $Language->Phrase("Search") ?></span><br>
        <div id="pagos_x_docto_list_SearchPanel">
            <form name="fpagos_x_doctolistsrch" id="fpagos_x_doctolistsrch" class="ewForm"
                ...
                <div class="ewBasicSearch">
                    <div id="xsr_1" class="ewCssTableRow">
                        <input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>"
                               ...
                               value="<?php echo ew_HtmlEncode($pagos_x_docto->getSessionBasicSearchKeyword()) ?>">
                    ...
                    <div id="xsr_2" class="ewCssTableRow">
                        <label><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                      ...
                                      value=""<?php if ($pagos_x_docto->getSessionBasicSearchType() == "") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("ExactPhrase") ?>
                        </label>&nbsp;&nbsp;<label><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                                          id="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                                          value="AND"<?php if ($pagos_x_docto->getSessionBasicSearchType() == "AND") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AllWord") ?>
                        </label>&nbsp;&nbsp;<label><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                                          id="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                                          value="OR"<?php if ($pagos_x_docto->getSessionBasicSearchType() == "OR") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AnyWord") ?>
                        </label>
                    </div>
                </div>
            </form>
                            ...
                            <tr class="ewTableHeader">
                                ...
                                <?php if ($pagos_x_docto->iddoctocontable->Visible) { // iddoctocontable ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_x_docto->SortUrl($pagos_x_docto->iddoctocontable) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_x_docto->iddoctocontable->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_x_docto->iddoctocontable->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_x_docto->iddoctocontable->getSort() == "DESC") { ?>
                                ...
                                <?php if ($pagos_x_docto->tipo_docto->Visible) { // tipo_docto ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_x_docto->SortUrl($pagos_x_docto->tipo_docto) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_x_docto->tipo_docto->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_x_docto->tipo_docto->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_x_docto->tipo_docto->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($pagos_x_docto->consec_docto->Visible) { // consec_docto ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_x_docto->SortUrl($pagos_x_docto->consec_docto) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_x_docto->consec_docto->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_x_docto->consec_docto->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_x_docto->consec_docto->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($pagos_x_docto->valor->Visible) { // valor ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_x_docto->SortUrl($pagos_x_docto->valor) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_x_docto->valor->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_x_docto->valor->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_x_docto->valor->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($pagos_x_docto->cia->Visible) { // cia ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_x_docto->SortUrl($pagos_x_docto->cia) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_x_docto->cia->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_x_docto->cia->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_x_docto->cia->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($pagos_x_docto->nit->Visible) { // nit ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_x_docto->SortUrl($pagos_x_docto->nit) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_x_docto->nit->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_x_docto->nit->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_x_docto->nit->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($pagos_x_docto->fecha->Visible) { // fecha ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_x_docto->SortUrl($pagos_x_docto->fecha) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_x_docto->fecha->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_x_docto->fecha->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_x_docto->fecha->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($pagos_x_docto->dias_vencidos->Visible) { // dias_vencidos ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_x_docto->SortUrl($pagos_x_docto->dias_vencidos) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_x_docto->dias_vencidos->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_x_docto->dias_vencidos->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_x_docto->dias_vencidos->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($pagos_x_docto->estado->Visible) { // estado ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_x_docto->SortUrl($pagos_x_docto->estado) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_x_docto->estado->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_x_docto->estado->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_x_docto->estado->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($pagos_x_docto->estado_pago->Visible) { // estado_pago ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_x_docto->SortUrl($pagos_x_docto->estado_pago) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_x_docto->estado_pago->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_x_docto->estado_pago->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_x_docto->estado_pago->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($pagos_x_docto->fecha_vencimiento->Visible) { // fecha_vencimiento ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_x_docto->SortUrl($pagos_x_docto->fecha_vencimiento) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_x_docto->fecha_vencimiento->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_x_docto->fecha_vencimiento->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_x_docto->fecha_vencimiento->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($pagos_x_docto->monto_pago->Visible) { // monto_pago ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_x_docto->SortUrl($pagos_x_docto->monto_pago) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_x_docto->monto_pago->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_x_docto->monto_pago->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_x_docto->monto_pago->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                    ...
                                    <tr<?php echo $pagos_x_docto->RowAttributes() ?>>
                                        ...
                                        <?php if ($pagos_x_docto->iddoctocontable->Visible) { // iddoctocontable ?>
                                            <td<?php echo $pagos_x_docto->iddoctocontable->CellAttributes() ?>>
                                                ...
                                                <a name="<?php echo $pagos_x_docto_list->PageObjName . "_row_" . $pagos_x_docto_list->RowCnt ?>"
                                                   id="<?php echo $pagos_x_docto_list->PageObjName . "_row_" . $pagos_x_docto_list->RowCnt ?>"></a>
                                            </td>
                                        <?php } ?>
                                        <?php if ($pagos_x_docto->tipo_docto->Visible) { // tipo_docto ?>
                                    ...
                                    <td nowrap>
                                        <span class="phpmaker pager">
                                            ...
                                            <?php foreach ($pagos_x_docto_list->Pager->Items as $PagerItem) { ?>
                                                        <?php if ($PagerItem->Enabled) { ?><a href="<?php echo $pagos_x_docto_list->PageUrl() ?>start=<?php echo $PagerItem->Start ?>"><?php } ?>
