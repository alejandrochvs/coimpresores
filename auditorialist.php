...
<p class="phpmaker ewTitle"
   style="white-space: nowrap;"><?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $auditoria->TableCaption() ?>
        <?php $auditoria_list->ExportOptions->Render("body"); ?>
</p>
<?php if ($Security->CanSearch()) { ?>
    <?php if ($auditoria->Export == "" && $auditoria->CurrentAction == "") { ?>
        <a href="javascript:ew_ToggleSearchPanel(auditoria_list);" style="text-decoration: none;"><img
                    id="auditoria_list_SearchImage" src="phpimages/collapse.gif" alt="" width="9" height="9" border="0"></a>
        <span class="phpmaker">  <?php echo $Language->Phrase("Search") ?></span><br>
        <div id="auditoria_list_SearchPanel">
            <form name="fauditorialistsrch" id="fauditorialistsrch" class="ewForm"
                ...
                <div class="ewBasicSearch">
                    <div id="xsr_1" class="ewCssTableRow">
                        <input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>"
                               ...
                               value="<?php echo ew_HtmlEncode($auditoria->getSessionBasicSearchKeyword()) ?>">
                    ...
                    <div id="xsr_2" class="ewCssTableRow">
                        <label><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                      ...
                                      value=""<?php if ($auditoria->getSessionBasicSearchType() == "") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("ExactPhrase") ?>
                        </label>    <label><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                                          id="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                                          value="AND"<?php if ($auditoria->getSessionBasicSearchType() == "AND") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AllWord") ?>
                        </label>    <label><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                                          id="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                                          value="OR"<?php if ($auditoria->getSessionBasicSearchType() == "OR") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AnyWord") ?>
                        </label>
                    </div>
                </div>
            </form>
                            ...
                            <tr class="ewTableHeader">
                                ...
                                <?php if ($auditoria->id->Visible) { // id ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $auditoria->SortUrl($auditoria->id) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $auditoria->id->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($auditoria->id->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($auditoria->id->getSort() == "DESC") { ?>
                                ...
                                <?php if ($auditoria->fecha_hora->Visible) { // fecha_hora ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $auditoria->SortUrl($auditoria->fecha_hora) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $auditoria->fecha_hora->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($auditoria->fecha_hora->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($auditoria->fecha_hora->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($auditoria->script->Visible) { // script ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $auditoria->SortUrl($auditoria->script) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $auditoria->script->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($auditoria->script->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($auditoria->script->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($auditoria->usuario->Visible) { // usuario ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $auditoria->SortUrl($auditoria->usuario) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $auditoria->usuario->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($auditoria->usuario->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($auditoria->usuario->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($auditoria->accion->Visible) { // accion ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $auditoria->SortUrl($auditoria->accion) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $auditoria->accion->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($auditoria->accion->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($auditoria->accion->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($auditoria->tabla->Visible) { // tabla ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $auditoria->SortUrl($auditoria->tabla) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $auditoria->tabla->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($auditoria->tabla->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($auditoria->tabla->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($auditoria->campo->Visible) { // campo ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $auditoria->SortUrl($auditoria->campo) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $auditoria->campo->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($auditoria->campo->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($auditoria->campo->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                    ...
                                    <tr<?php echo $auditoria->RowAttributes() ?>>
                                        ...
                                        <?php if ($auditoria->id->Visible) { // id ?>
                                            <td<?php echo $auditoria->id->CellAttributes() ?>>
                                                ...
                                                <a name="<?php echo $auditoria_list->PageObjName . "_row_" . $auditoria_list->RowCnt ?>"
                                                   id="<?php echo $auditoria_list->PageObjName . "_row_" . $auditoria_list->RowCnt ?>"></a>
                                            </td>
                                        <?php } ?>
                                        <?php if ($auditoria->fecha_hora->Visible) { // fecha_hora ?>
                                        ...
                                        <span class="phpmaker pager">
                                            <span class="row">
                                                ...
                                                <?php if ($auditoria_list->Pager->FirstButton->Enabled) { ?>
                                                    <a href="<?php echo $auditoria_list->PageUrl() ?>start=<?php echo $auditoria_list->Pager->FirstButton->Start ?>"><i class="fa fa-x fa-angle-double-left"></i></a>
                                                <?php } ?>
                                                <?php if ($auditoria_list->Pager->PrevButton->Enabled) { ?>
                                                    <a href="<?php echo $auditoria_list->PageUrl() ?>start=<?php echo $auditoria_list->Pager->PrevButton->Start ?>"><i class="fa fa-2x fa-angle-left"></i></a>
                                                <?php } ?>
                                                <?php foreach ($auditoria_list->Pager->Items as $PagerItem) { ?>
                                                    <?php if ($PagerItem->Enabled) { ?><a href="<?php echo $auditoria_list->PageUrl() ?>start=<?php echo $PagerItem->Start ?>"><?php } ?>
                                                    <b><?php echo $PagerItem->Text ?></b><?php if ($PagerItem->Enabled) { ?></a><?php } ?>  
                                                <?php } ?>
                                                <?php if ($auditoria_list->Pager->NextButton->Enabled) { ?>
                                                    <a href="<?php echo $auditoria_list->PageUrl() ?>start=<?php echo $auditoria_list->Pager->NextButton->Start ?>"><i class="fa fa-2x fa-angle-right"></i></a>
                                                <?php } ?>
                                                <?php if ($auditoria_list->Pager->LastButton->Enabled) { ?>
                                                    <a href="<?php echo $auditoria_list->PageUrl() ?>start=<?php echo $auditoria_list->Pager->LastButton->Start ?>"><i class="fa fa-2x fa-angle-double-right"></i></a>
                                                <?php } ?>
                                            </span>
                                            <span class="row">
