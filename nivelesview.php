...
<?php } ?>
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $niveles->TableCaption() ?>
...
<div<?php echo $niveles->idnivel->ViewAttributes() ?>><?php echo $niveles->idnivel->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $niveles->nombrenivel->ViewAttributes() ?>><?php echo $niveles->nombrenivel->ViewValue ?></div></td>
	</tr>
<?php } ?>
</table>
</div>
