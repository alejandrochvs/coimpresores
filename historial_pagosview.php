...
<?php } ?>
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $historial_pagos->TableCaption() ?>
...
<div<?php echo $historial_pagos->idhistorial_pagos->ViewAttributes() ?>><?php echo $historial_pagos->idhistorial_pagos->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $historial_pagos->usuario->ViewAttributes() ?>><?php echo $historial_pagos->usuario->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $historial_pagos->estado_pago->ViewAttributes() ?>><?php echo $historial_pagos->estado_pago->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $historial_pagos->ref_venta->ViewAttributes() ?>><?php echo $historial_pagos->ref_venta->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $historial_pagos->fecha_hora_creacion->ViewAttributes() ?>><?php echo $historial_pagos->fecha_hora_creacion->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $historial_pagos->riesgo->ViewAttributes() ?>><?php echo $historial_pagos->riesgo->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $historial_pagos->respuesta_pol->ViewAttributes() ?>><?php echo $historial_pagos->respuesta_pol->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $historial_pagos->monto_pago->ViewAttributes() ?>><?php echo $historial_pagos->monto_pago->ViewValue ?></div></td>
	</tr>
<?php } ?>
</table>
</div>
