...
<form action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return login.ValidateForm(this);">
    <table border="0" cellspacing="0" cellpadding="4" class="login-table">
        <tr></tr>
        <tr>
            <td style="display: grid;grid-template-columns: 20% 1fr; align-content: center; justify-content: center">
                <img style="width: 100%; height: auto; margin: auto" src="modules/global/img/logo.png" alt="">
                <span class="trabaja">Le invitamos a pagar en l&iacute;nea y obtener beneficios de ahorro de tiempo, seguridad y soluci&oacute;n a la mano.<br> Solic&iacute;te su usuario y contraseña y
comience a utilizar este f&aacute;cil medio virtual para estar al d&iacute;a con la Cooperativa.</span>
            </td>
        </tr>
        <tr>
            <td rowspan="30">
                <img class="img" src="../images/Noticias/Noticias.png" alt=""/>
            </td>
            <td>
                <h2 class="phpmaker"><?php echo $Language->Phrase("Username") ?></h2>
            </td>
            <td>
                <span class="phpmaker">
                    <input type="text" name="username" id="username" size="20" value="<?php echo $login->Username ?>">
                </span>
            </td>
        </tr>
        <tr>
            <td>
                <h2 class="phpmaker"><?php echo $Language->Phrase("Password") ?></h2>
            </td>
            <td>
                <span class="phpmaker"><input type="password" name="password" id="password" size="20"></span>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <span class="phpmaker">
                    <label>
                        <input type="radio" name="rememberme" id="rememberme"
                               value="a"<?php if ($login->LoginType == "a") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AutoLogin") ?></label><br>
                    <label>
                        <input type="radio" name="rememberme" id="rememberme"
                               value="u"<?php if ($login->LoginType == "u") { ?>  checked="checked"<?php } ?>><?php echo $Language->Phrase("SaveUserName") ?></label><br>
                    <label>
                        <input type="radio" name="rememberme" id="rememberme"
                               value=""<?php if ($login->LoginType == "") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AlwaysAsk") ?></label>
                </span>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="center">
                <span class="phpmaker">
                    <button type="submit" name="submit" id="submit"
                            value="<?php echo ew_BtnCaption($Language->Phrase("Login")) ?>">Entrar</button>
                </span>
            </td>
        </tr>
    </table>
