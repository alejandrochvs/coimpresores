...
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("Edit") ?>
    &nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $usuarios->TableCaption() ?></p>
...
?>
<form name="fusuariosedit" id="fusuariosedit" action="<?php echo ew_CurrentPage() ?>" method="post"
      onsubmit="return usuarios_edit.ValidateForm(this);">
    <p>
...
<input type="hidden" name="x_idusuario" id="x_idusuario"
       value="<?php echo ew_HtmlEncode($usuarios->idusuario->CurrentValue) ?>">
...
<input type="text" name="x_username" id="x_username" size="30" maxlength="90"
       value="<?php echo $usuarios->username->EditValue ?>"<?php echo $usuarios->username->EditAttributes() ?>>
...
<input type="password" name="x_password" id="x_password" value="<?php echo $usuarios->password->EditValue ?>" size="30"
       maxlength="64"<?php echo $usuarios->password->EditAttributes() ?>>
...
<input type="text" name="x_zemail" id="x_zemail" size="30" maxlength="250"
       value="<?php echo $usuarios->zemail->EditValue ?>"<?php echo $usuarios->zemail->EditAttributes() ?>>
...
<input type="text" name="x_empresa" id="x_empresa" size="30" maxlength="200"
       value="<?php echo $usuarios->empresa->EditValue ?>"<?php echo $usuarios->empresa->EditAttributes() ?>>
...
<input type="text" name="x_nit_empresa" id="x_nit_empresa" size="30"
       value="<?php echo $usuarios->nit_empresa->EditValue ?>"<?php echo $usuarios->nit_empresa->EditAttributes() ?>>
...
<div id="tp_x_activo" class="<?php echo EW_ITEM_TEMPLATE_CLASSNAME ?>"><label><input type="radio" name="x_activo"
                                                                                     id="x_activo"
                                                                                     value="{value}"<?php echo $usuarios->activo->EditAttributes() ?>></label></div>
...
if (is_array($arwrk)) {
    ...
    for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
        ...
        <label><input type="radio" name="x_activo" id="x_activo"
                      value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $usuarios->activo->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
