...
<div<?php echo $auditoria->id->ViewAttributes() ?>><?php echo $auditoria->id->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $auditoria->fecha_hora->ViewAttributes() ?>><?php echo $auditoria->fecha_hora->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $auditoria->accion->ViewAttributes() ?>><?php echo $auditoria->accion->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $auditoria->campo->ViewAttributes() ?>><?php echo $auditoria->campo->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $auditoria->valorclave->ViewAttributes() ?>><?php echo $auditoria->valorclave->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $auditoria->viejovalor->ViewAttributes() ?>><?php echo $auditoria->viejovalor->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $auditoria->nuevovalor->ViewAttributes() ?>><?php echo $auditoria->nuevovalor->ViewValue ?></div></td>
	</tr>
<?php } ?>
</table>
</div>
