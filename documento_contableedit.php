...
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $documento_contable->TableCaption() ?></p>
...
?>
<form name="fdocumento_contableedit" id="fdocumento_contableedit" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return documento_contable_edit.ValidateForm(this);">
<p>
...
<?php if ($documento_contable->iddoctocontable->Visible) { // iddoctocontable ?>
	<tr id="r_iddoctocontable"<?php echo $documento_contable->RowAttributes() ?>>
		...
		<td<?php echo $documento_contable->iddoctocontable->CellAttributes() ?>><span id="el_iddoctocontable">
<div<?php echo $documento_contable->iddoctocontable->ViewAttributes() ?>><?php echo $documento_contable->iddoctocontable->EditValue ?></div>
<input type="hidden" name="x_iddoctocontable" id="x_iddoctocontable" value="<?php echo ew_HtmlEncode($documento_contable->iddoctocontable->CurrentValue) ?>">
...
<?php if ($documento_contable->tipo_docto->Visible) { // tipo_docto ?>
	<tr id="r_tipo_docto"<?php echo $documento_contable->RowAttributes() ?>>
		...
		<td<?php echo $documento_contable->tipo_docto->CellAttributes() ?>><span id="el_tipo_docto">
<input type="text" name="x_tipo_docto" id="x_tipo_docto" size="30" maxlength="45" value="<?php echo $documento_contable->tipo_docto->EditValue ?>"<?php echo $documento_contable->tipo_docto->EditAttributes() ?>>
...
<?php if ($documento_contable->consec_docto->Visible) { // consec_docto ?>
	<tr id="r_consec_docto"<?php echo $documento_contable->RowAttributes() ?>>
		...
		<td<?php echo $documento_contable->consec_docto->CellAttributes() ?>><span id="el_consec_docto">
<input type="text" name="x_consec_docto" id="x_consec_docto" size="30" value="<?php echo $documento_contable->consec_docto->EditValue ?>"<?php echo $documento_contable->consec_docto->EditAttributes() ?>>
...
<input type="text" name="x_valor" id="x_valor" size="30" value="<?php echo $documento_contable->valor->EditValue ?>"<?php echo $documento_contable->valor->EditAttributes() ?>>
...
<input type="text" name="x_cia" id="x_cia" size="30" value="<?php echo $documento_contable->cia->EditValue ?>"<?php echo $documento_contable->cia->EditAttributes() ?>>
...
<input type="text" name="x_tercero" id="x_tercero" size="30" maxlength="45" value="<?php echo $documento_contable->tercero->EditValue ?>"<?php echo $documento_contable->tercero->EditAttributes() ?>>
...
<input type="text" name="x_fecha" id="x_fecha" value="<?php echo $documento_contable->fecha->EditValue ?>"<?php echo $documento_contable->fecha->EditAttributes() ?>>
...
<input type="text" name="x_estado" id="x_estado" size="30" maxlength="45" value="<?php echo $documento_contable->estado->EditValue ?>"<?php echo $documento_contable->estado->EditAttributes() ?>>
...
<input type="hidden" name="x_usuario" id="x_usuario" value="<?php echo ew_HtmlEncode($documento_contable->usuario->CurrentValue) ?>">
<?php } else { ?>
<input type="text" name="x_usuario" id="x_usuario" size="30" value="<?php echo $documento_contable->usuario->EditValue ?>"<?php echo $documento_contable->usuario->EditAttributes() ?>>
<?php } ?>
...
<?php if ($documento_contable->estado_pago->Visible) { // estado_pago ?>
	<tr id="r_estado_pago"<?php echo $documento_contable->RowAttributes() ?>>
		...
		<td<?php echo $documento_contable->estado_pago->CellAttributes() ?>><span id="el_estado_pago">
<input type="text" name="x_estado_pago" id="x_estado_pago" size="30" value="<?php echo $documento_contable->estado_pago->EditValue ?>"<?php echo $documento_contable->estado_pago->EditAttributes() ?>>
