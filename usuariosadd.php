...
?>
<form name="fusuariosadd" id="fusuariosadd" action="<?php echo ew_CurrentPage() ?>" method="post"
      onsubmit="return usuarios_add.ValidateForm(this);">
    <p>
...
<input type="password" name="x_password" id="x_password" size="30"
