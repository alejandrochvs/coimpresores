...
<p class="phpmaker ewTitle"
   style="white-space: nowrap;"><?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $historial_pagos->TableCaption() ?>
      <?php $historial_pagos_list->ExportOptions->Render("body"); ?>
</p>
<?php if ($Security->CanSearch()) { ?>
    <?php if ($historial_pagos->Export == "" && $historial_pagos->CurrentAction == "") { ?>
        <a href="javascript:ew_ToggleSearchPanel(historial_pagos_list);" style="text-decoration: none;"><img
                    id="historial_pagos_list_SearchImage" src="phpimages/collapse.gif" alt="" width="9" height="9"
                    border="0"></a><span class="phpmaker"> <?php echo $Language->Phrase("Search") ?></span><br>
        <div id="historial_pagos_list_SearchPanel">
            <form name="fhistorial_pagoslistsrch" id="fhistorial_pagoslistsrch" class="ewForm"
                ...
                <div class="ewBasicSearch">
                    <div id="xsr_1" class="ewCssTableRow">
                        <input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>"
                               ...
                               value="<?php echo ew_HtmlEncode($historial_pagos->getSessionBasicSearchKeyword()) ?>">
                    ...
                    <div id="xsr_2" class="ewCssTableRow">
                        <label><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                      ...
                                      value=""<?php if ($historial_pagos->getSessionBasicSearchType() == "") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("ExactPhrase") ?>
                        </label>  <label><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                                          id="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                                          value="AND"<?php if ($historial_pagos->getSessionBasicSearchType() == "AND") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AllWord") ?>
                        </label>  <label><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                                          id="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>"
                                                          value="OR"<?php if ($historial_pagos->getSessionBasicSearchType() == "OR") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AnyWord") ?>
                        </label>
                    </div>
                </div>
            </form>
...
<?php if ($Security->CanAdd()) { ?>
    <a class="ewGridLink"
       href="<?php echo $historial_pagos_list->AddUrl ?>"><i class="fa fa-plus"></i> <?php echo $Language->Phrase("AddLink") ?></a>
<?php if ($pagos_x_docto->DetailAdd && $Security->AllowAdd('pagos_x_docto')) { ?>
        <a class="ewGridLink"
           href="<?php echo $historial_pagos->AddUrl() . "?" . EW_TABLE_SHOW_DETAIL . "=pagos_x_docto" ?>"><?php echo $Language->Phrase("AddLink") ?>
            <?php echo $historial_pagos->TableCaption() ?>
            /<?php echo $pagos_x_docto->TableCaption() ?></a>
    <?php } ?>
<?php } ?>
</span>
<table cellspacing="0" class="ewGrid" style="margin-top: 2vh">
    <tr>
                            ...
                            <tr class="ewTableHeader">
                                ...
                                <?php if ($historial_pagos->idhistorial_pagos->Visible) { // idhistorial_pagos ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $historial_pagos->SortUrl($historial_pagos->idhistorial_pagos) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $historial_pagos->idhistorial_pagos->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($historial_pagos->idhistorial_pagos->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($historial_pagos->idhistorial_pagos->getSort() == "DESC") { ?>
                                ...
                                <?php if ($historial_pagos->usuario->Visible) { // usuario ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $historial_pagos->SortUrl($historial_pagos->usuario) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $historial_pagos->usuario->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($historial_pagos->usuario->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($historial_pagos->usuario->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($historial_pagos->estado_pago->Visible) { // estado_pago ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $historial_pagos->SortUrl($historial_pagos->estado_pago) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $historial_pagos->estado_pago->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($historial_pagos->estado_pago->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($historial_pagos->estado_pago->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($historial_pagos->ref_venta->Visible) { // ref_venta ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $historial_pagos->SortUrl($historial_pagos->ref_venta) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $historial_pagos->ref_venta->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($historial_pagos->ref_venta->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($historial_pagos->ref_venta->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($historial_pagos->fecha_hora_creacion->Visible) { // fecha_hora_creacion ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $historial_pagos->SortUrl($historial_pagos->fecha_hora_creacion) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $historial_pagos->fecha_hora_creacion->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($historial_pagos->fecha_hora_creacion->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($historial_pagos->fecha_hora_creacion->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($historial_pagos->riesgo->Visible) { // riesgo ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $historial_pagos->SortUrl($historial_pagos->riesgo) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $historial_pagos->riesgo->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td>
                                                        <td style="width: 10px;"><?php if ($historial_pagos->riesgo->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($historial_pagos->riesgo->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($historial_pagos->monto_pago->Visible) { // monto_pago ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $historial_pagos->SortUrl($historial_pagos->monto_pago) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $historial_pagos->monto_pago->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($historial_pagos->monto_pago->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($historial_pagos->monto_pago->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                    ...
                                    <tr<?php echo $historial_pagos->RowAttributes() ?>>
                                        ...
                                        <?php if ($historial_pagos->idhistorial_pagos->Visible) { // idhistorial_pagos ?>
                                            <td<?php echo $historial_pagos->idhistorial_pagos->CellAttributes() ?>>
                                                ...
                                                <a name="<?php echo $historial_pagos_list->PageObjName . "_row_" . $historial_pagos_list->RowCnt ?>"
                                                   id="<?php echo $historial_pagos_list->PageObjName . "_row_" . $historial_pagos_list->RowCnt ?>"></a>
                                            </td>
                                        <?php } ?>
                                        <?php if ($historial_pagos->usuario->Visible) { // usuario ?>
...
<span class="phpmaker pager">
    <span class="row">
        ...
        <?php if ($historial_pagos_list->Pager->FirstButton->Enabled) { ?>
            <a href="<?php echo $historial_pagos_list->PageUrl() ?>start=<?php echo $historial_pagos_list->Pager->FirstButton->Start ?>"><i class="fa fa-2x fa-angle-double-left"></i> </a>
        <?php } ?>
        <?php if ($historial_pagos_list->Pager->PrevButton->Enabled) { ?>
            <a href="<?php echo $historial_pagos_list->PageUrl() ?>start=<?php echo $historial_pagos_list->Pager->PrevButton->Start ?>"><i class="fa fa-2x fa-angle-left"></i> </a>
        <?php } ?>
        <?php foreach ($historial_pagos_list->Pager->Items as $PagerItem) { ?>
            <?php if ($PagerItem->Enabled) { ?><a href="<?php echo $historial_pagos_list->PageUrl() ?>start=<?php echo $PagerItem->Start ?>"><?php } ?>
            <b><?php echo $PagerItem->Text ?></b><?php if ($PagerItem->Enabled) { ?></a><?php } ?> 
        <?php } ?>
        <?php if ($historial_pagos_list->Pager->NextButton->Enabled) { ?>
            <a href="<?php echo $historial_pagos_list->PageUrl() ?>start=<?php echo $historial_pagos_list->Pager->NextButton->Start ?>"><i class="fa fa-2x fa-angle-right"></i> </a>
        <?php } ?>
        <?php if ($historial_pagos_list->Pager->LastButton->Enabled) { ?>
            <a href="<?php echo $historial_pagos_list->PageUrl() ?>start=<?php echo $historial_pagos_list->Pager->LastButton->Start ?>"><i class="fa fa-2x fa-angle-double-right"></i> </a>
        <?php } ?>
    </span>
    <span class="row">
...
class chistorial_pagos_list
{
    ...
    function RenderListOptions()
    {
        ...
        if ($Security->CanView() && $this->ShowOptionLink() && $oListOpt->Visible)
            $oListOpt->Body = "<a class=\"ewRowLink\" href=\"" . $this->ViewUrl . "\">" . "<i class=\"fa fa-eye fa-2x\" alt=\"" . ew_HtmlEncode($Language->Phrase("ViewLink")) . "\" title=\"" . ew_HtmlEncode($Language->Phrase("ViewLink")) . "\"></i>" . "</a>";

        // "edit"
        $oListOpt =& $this->ListOptions->Items["edit"];
        if ($Security->CanEdit() && $this->ShowOptionLink() && $oListOpt->Visible) {
            $oListOpt->Body = "<a class=\"ewRowLink\" href=\"" . $this->EditUrl . "\">" . "<i class=\"fa fa-pencil-square-o fa-2x\" alt=\"" . ew_HtmlEncode($Language->Phrase("EditLink")) . "\" title=\"" . ew_HtmlEncode($Language->Phrase("EditLink")) . "\"></i>" . "</a>";
        }

        // "delete"
        $oListOpt =& $this->ListOptions->Items["delete"];
        if ($Security->CanDelete() && $this->ShowOptionLink() && $oListOpt->Visible)
            $oListOpt->Body = "<a class=\"ewRowLink\"" . "" . " href=\"" . $this->DeleteUrl . "\">" . "<i class=\"fa fa-times fa-2x\" alt=\"" . ew_HtmlEncode($Language->Phrase("DeleteLink")) . "\" title=\"" . ew_HtmlEncode($Language->Phrase("DeleteLink")) . "\"></i>" . "</a>";
