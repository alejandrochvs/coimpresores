...
define("EW_DEFAULT_DATE_FORMAT_ID", "11", TRUE); // Default date format
define("EW_DATE_SEPARATOR", "/", TRUE); // Date separator
define("EW_UNFORMAT_YEAR", 50, TRUE); // Unformat year
define("EW_PROJECT_NAME", "coimpresore2Dpagos1", TRUE); // Project name
define("EW_RANDOM_KEY", 'BT4iACLpxwbb7KdS', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/coimpresore2dpagos1.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_HOST", 'parsoniiseo.com', TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", 'jparsoni_coimpre', TRUE);
define("EW_CONN_PASS", '3ZN2VQ*A,@@L', TRUE);
define("EW_CONN_DB", 'jparsoni_coimprepagos', TRUE);
...
define("EW_AUDIT_TRAIL_TABLE_NAME", "auditoria", TRUE); // Audit trail table name
define("EW_AUDIT_TRAIL_FIELD_NAME_DATETIME", "fecha_hora", TRUE); // Audit trail DateTime field name
define("EW_AUDIT_TRAIL_FIELD_NAME_SCRIPT", "script", TRUE); // Audit trail Script field name
define("EW_AUDIT_TRAIL_FIELD_NAME_USER", "usuario", TRUE); // Audit trail User field name
define("EW_AUDIT_TRAIL_FIELD_NAME_ACTION", "accion", TRUE); // Audit trail Action field name
define("EW_AUDIT_TRAIL_FIELD_NAME_TABLE", "tabla", TRUE); // Audit trail Table field name
define("EW_AUDIT_TRAIL_FIELD_NAME_FIELD", "campo", TRUE); // Audit trail Field field name
define("EW_AUDIT_TRAIL_FIELD_NAME_KEYVALUE", "valorclave", TRUE); // Audit trail Key Value field name
define("EW_AUDIT_TRAIL_FIELD_NAME_OLDVALUE", "viejovalor", TRUE); // Audit trail Old Value field name
define("EW_AUDIT_TRAIL_FIELD_NAME_NEWVALUE", "nuevovalor", TRUE); // Audit trail New Value field name
...
$EW_USER_LEVEL_TABLE_NAME[] = 'documento_contable';
$EW_USER_LEVEL_TABLE_VAR[] = 'documento_contable';
$EW_USER_LEVEL_TABLE_NAME[] = 'historial_pagos';
$EW_USER_LEVEL_TABLE_VAR[] = 'historial_pagos';
$EW_USER_LEVEL_TABLE_NAME[] = 'usuarios';
$EW_USER_LEVEL_TABLE_VAR[] = 'usuarios';
$EW_USER_LEVEL_TABLE_NAME[] = 'auditoria';
$EW_USER_LEVEL_TABLE_VAR[] = 'auditoria';
$EW_USER_LEVEL_TABLE_NAME[] = 'pagos_online';
$EW_USER_LEVEL_TABLE_VAR[] = 'pagos_online';
$EW_USER_LEVEL_TABLE_NAME[] = 'pagos_x_docto';
$EW_USER_LEVEL_TABLE_VAR[] = 'pagos_x_docto';
$EW_USER_LEVEL_TABLE_CAPTION = array_fill(0, 6, ''); // Blank, use $Language object. For compatibility with PHP Report Maker 3 only.
...
@define("EW_USER_LEVEL_TABLE", "`niveles`", TRUE);
@define("EW_USER_LEVEL_ID_FIELD", "`idnivel`", TRUE);
@define("EW_USER_LEVEL_NAME_FIELD", "`nombrenivel`", TRUE);

// User Level privileges table/field names
@define("EW_USER_LEVEL_PRIV_TABLE", "`permisos`", TRUE);
@define("EW_USER_LEVEL_PRIV_TABLE_NAME_FIELD", "`nombretabla`", TRUE);
@define("EW_USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD", "`idnivel`", TRUE);
...
define("EW_USER_PROFILE_MAX_RETRY", 10, TRUE);
...
define("EW_USER_PROFILE_PASSWORD_EXPIRE", 180, TRUE);
...
define("EW_SENDER_EMAIL", "info@coimpresores.com.co", TRUE); // Sender email address
...
?>
<?php
define("EW_CAPTCHA_FONT", "aftershock.ttf", TRUE);
?>
<?php
