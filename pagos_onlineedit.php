...
?>
<form name="fpagos_onlineedit" id="fpagos_onlineedit" action="<?php echo ew_CurrentPage() ?>" method="post"
      onsubmit="return pagos_online_edit.ValidateForm(this);">
    <p>
...
<input type="hidden" name="x_idpagosonline" id="x_idpagosonline"
       value="<?php echo ew_HtmlEncode($pagos_online->idpagosonline->CurrentValue) ?>">
