...
$documento_contable = NULL;

//
// Table class for documento_contable
//
class cdocumento_contable {
	var $TableVar = 'documento_contable';
	...
	//
	function cdocumento_contable() {
		global $Language;
		$this->AllowAddDeleteRow = ew_AllowAddDeleteRow(); // Allow add/delete row

		// iddoctocontable
		$this->iddoctocontable = new cField('documento_contable', 'documento_contable', 'x_iddoctocontable', 'iddoctocontable', '`iddoctocontable`', 19, -1, FALSE, '`iddoctocontable`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->iddoctocontable->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['iddoctocontable'] =& $this->iddoctocontable;

		// tipo_docto
		$this->tipo_docto = new cField('documento_contable', 'documento_contable', 'x_tipo_docto', 'tipo_docto', '`tipo_docto`', 200, -1, FALSE, '`tipo_docto`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['tipo_docto'] =& $this->tipo_docto;

		// consec_docto
		$this->consec_docto = new cField('documento_contable', 'documento_contable', 'x_consec_docto', 'consec_docto', '`consec_docto`', 3, -1, FALSE, '`consec_docto`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->consec_docto->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['consec_docto'] =& $this->consec_docto;

		// valor
		$this->valor = new cField('documento_contable', 'documento_contable', 'x_valor', 'valor', '`valor`', 3, -1, FALSE, '`valor`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->valor->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['valor'] =& $this->valor;

		// cia
		$this->cia = new cField('documento_contable', 'documento_contable', 'x_cia', 'cia', '`cia`', 3, -1, FALSE, '`cia`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cia->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cia'] =& $this->cia;

		// tercero
		$this->tercero = new cField('documento_contable', 'documento_contable', 'x_tercero', 'tercero', '`tercero`', 200, -1, FALSE, '`tercero`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['tercero'] =& $this->tercero;

		// fecha
		$this->fecha = new cField('documento_contable', 'documento_contable', 'x_fecha', 'fecha', '`fecha`', 133, 7, FALSE, '`fecha`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fecha->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['fecha'] =& $this->fecha;

		// fecha_vencimiento
		$this->fecha_vencimiento = new cField('documento_contable', 'documento_contable', 'x_fecha_vencimiento', 'fecha_vencimiento', '`fecha_vencimiento`', 133, -1, FALSE, '`fecha_vencimiento`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['fecha_vencimiento'] =& $this->fecha_vencimiento;

		// estado
		$this->estado = new cField('documento_contable', 'documento_contable', 'x_estado', 'estado', '`estado`', 200, -1, FALSE, '`estado`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['estado'] =& $this->estado;

		// dias_vencidos
		$this->dias_vencidos = new cField('documento_contable', 'documento_contable', 'x_dias_vencidos', 'dias_vencidos', '`dias_vencidos`', 3, -1, FALSE, '`dias_vencidos`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->dias_vencidos->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['dias_vencidos'] =& $this->dias_vencidos;

		// usuario
		$this->usuario = new cField('documento_contable', 'documento_contable', 'x_usuario', 'usuario', '`usuario`', 19, -1, FALSE, '`usuario`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->usuario->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['usuario'] =& $this->usuario;

		// estado_pago
		$this->estado_pago = new cField('documento_contable', 'documento_contable', 'x_estado_pago', 'estado_pago', '`estado_pago`', 3, -1, FALSE, '`estado_pago`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->estado_pago->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['estado_pago'] =& $this->estado_pago;

		// descripcion
		$this->descripcion = new cField('documento_contable', 'documento_contable', 'x_descripcion', 'descripcion', '`descripcion`', 201, -1, FALSE, '`descripcion`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['descripcion'] =& $this->descripcion;

		// nit
		$this->nit = new cField('documento_contable', 'documento_contable', 'x_nit', 'nit', '`nit`', 200, -1, FALSE, '`nit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nit'] =& $this->nit;

		// fecha_actualizacion
		$this->fecha_actualizacion = new cField('documento_contable', 'documento_contable', 'x_fecha_actualizacion', 'fecha_actualizacion', '`fecha_actualizacion`', 135, -1, FALSE, '`fecha_actualizacion`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "documento_contable_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `documento_contable` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `documento_contable` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `documento_contable` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "documento_contablelist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("documento_contableview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "documento_contableadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("documento_contableedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("documento_contableadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("documento_contabledelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=documento_contable" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
		...
		$sSqlWrk .= " ORDER BY `nit_empresa` Asc";
			...
			if ($rswrk && !$rswrk->EOF) { // Lookup values found
				$this->usuario->ViewValue = $rswrk->fields('nit_empresa');
				$this->usuario->ViewValue .= ew_ValueSeparator(0,1,$this->usuario) . $rswrk->fields('username');
				$rswrk->Close();
			} else {
		...
		// estado_pago
		if (strval($this->estado_pago->CurrentValue) <> "") {
			switch ($this->estado_pago->CurrentValue) {
				case "0":
					$this->estado_pago->ViewValue = $this->estado_pago->FldTagCaption(1) <> "" ? $this->estado_pago->FldTagCaption(1) : $this->estado_pago->CurrentValue;
					break;
				case "1":
					$this->estado_pago->ViewValue = $this->estado_pago->FldTagCaption(2) <> "" ? $this->estado_pago->FldTagCaption(2) : $this->estado_pago->CurrentValue;
					break;
				case "2":
					$this->estado_pago->ViewValue = $this->estado_pago->FldTagCaption(3) <> "" ? $this->estado_pago->FldTagCaption(3) : $this->estado_pago->CurrentValue;
					break;
				case "4":
					$this->estado_pago->ViewValue = $this->estado_pago->FldTagCaption(4) <> "" ? $this->estado_pago->FldTagCaption(4) : $this->estado_pago->CurrentValue;
					break;
				case "5":
					$this->estado_pago->ViewValue = $this->estado_pago->FldTagCaption(5) <> "" ? $this->estado_pago->FldTagCaption(5) : $this->estado_pago->CurrentValue;
					break;
				case "6":
					$this->estado_pago->ViewValue = $this->estado_pago->FldTagCaption(6) <> "" ? $this->estado_pago->FldTagCaption(6) : $this->estado_pago->CurrentValue;
					break;
				case "7":
					$this->estado_pago->ViewValue = $this->estado_pago->FldTagCaption(7) <> "" ? $this->estado_pago->FldTagCaption(7) : $this->estado_pago->CurrentValue;
					break;
				case "8":
					$this->estado_pago->ViewValue = $this->estado_pago->FldTagCaption(8) <> "" ? $this->estado_pago->FldTagCaption(8) : $this->estado_pago->CurrentValue;
					break;
				case "9":
					$this->estado_pago->ViewValue = $this->estado_pago->FldTagCaption(9) <> "" ? $this->estado_pago->FldTagCaption(9) : $this->estado_pago->CurrentValue;
					break;
				case "10":
					$this->estado_pago->ViewValue = $this->estado_pago->FldTagCaption(10) <> "" ? $this->estado_pago->FldTagCaption(10) : $this->estado_pago->CurrentValue;
					break;
				default:
					$this->estado_pago->ViewValue = $this->estado_pago->CurrentValue;
			}
		} else {
			$this->estado_pago->ViewValue = NULL;
		}
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					$XmlDoc->AddField('fecha_actualizacion', $this->fecha_actualizacion->ExportValue($this->Export, $this->ExportOriginalValue));
				} else {
					$XmlDoc->AddField('iddoctocontable', $this->iddoctocontable->ExportValue($this->Export, $this->ExportOriginalValue));
					$XmlDoc->AddField('tipo_docto', $this->tipo_docto->ExportValue($this->Export, $this->ExportOriginalValue));
					$XmlDoc->AddField('consec_docto', $this->consec_docto->ExportValue($this->Export, $this->ExportOriginalValue));
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				$Doc->ExportCaption($this->fecha_actualizacion);
			} else {
				$Doc->ExportCaption($this->iddoctocontable);
				$Doc->ExportCaption($this->tipo_docto);
				$Doc->ExportCaption($this->consec_docto);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					$Doc->ExportField($this->fecha_actualizacion);
				} else {
					$Doc->ExportField($this->iddoctocontable);
					$Doc->ExportField($this->tipo_docto);
					$Doc->ExportField($this->consec_docto);
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `documento_contable` WHERE " . $this->AddUserIDFilter("");
