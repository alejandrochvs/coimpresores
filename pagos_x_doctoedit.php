...
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $pagos_x_docto->TableCaption() ?></p>
...
?>
<form name="fpagos_x_doctoedit" id="fpagos_x_doctoedit" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return pagos_x_docto_edit.ValidateForm(this);">
<p>
...
<?php if ($pagos_x_docto->iddoctocontable->Visible) { // iddoctocontable ?>
	<tr id="r_iddoctocontable"<?php echo $pagos_x_docto->RowAttributes() ?>>
		...
		<td<?php echo $pagos_x_docto->iddoctocontable->CellAttributes() ?>><span id="el_iddoctocontable">
<div<?php echo $pagos_x_docto->iddoctocontable->ViewAttributes() ?>><?php echo $pagos_x_docto->iddoctocontable->EditValue ?></div>
<input type="hidden" name="x_iddoctocontable" id="x_iddoctocontable" value="<?php echo ew_HtmlEncode($pagos_x_docto->iddoctocontable->CurrentValue) ?>">
...
<input type="hidden" id="x_historial" name="x_historial" value="<?php echo ew_HtmlEncode($pagos_x_docto->historial->CurrentValue) ?>">
<?php } else { ?>
