...
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $documento_contable->TableCaption() ?></p>
...
?>
<form name="fdocumento_contableadd" id="fdocumento_contableadd" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return documento_contable_add.ValidateForm(this);">
<p>
