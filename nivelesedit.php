...
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $niveles->TableCaption() ?></p>
...
?>
<form name="fnivelesedit" id="fnivelesedit" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return niveles_edit.ValidateForm(this);">
<p>
...
<input type="hidden" name="x_idnivel" id="x_idnivel" value="<?php echo ew_HtmlEncode($niveles->idnivel->CurrentValue) ?>">
