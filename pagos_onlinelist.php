                            ...
                            <tr class="ewTableHeader">
                                ...
                                <?php if ($pagos_online->usuarioid->Visible) { // usuarioid ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_online->SortUrl($pagos_online->usuarioid) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_online->usuarioid->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_online->usuarioid->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_online->usuarioid->getSort() == "DESC") { ?>
                                ...
                                <?php if ($pagos_online->llave_encripcion->Visible) { // llave_encripcion ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_online->SortUrl($pagos_online->llave_encripcion) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_online->llave_encripcion->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_online->llave_encripcion->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_online->llave_encripcion->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                ...
                                <?php if ($pagos_online->url->Visible) { // url ?>
                                    ...
                                    <?php } else { ?>
                                        <td>
                                            <div class="ewPointer"
                                                 onmousedown="ew_Sort(event,'<?php echo $pagos_online->SortUrl($pagos_online->url) ?>',1);">
                                                <table cellspacing="0" class="ewTableHeaderBtn">
                                                    <thead>
                                                    <tr>
                                                        <td><?php echo $pagos_online->url->FldCaption() ?></td>
                                                        <td style="width: 10px;"><?php if ($pagos_online->url->getSort() == "ASC") { ?>
                                                                <img src="phpimages/sortup.gif" width="10" height="9"
                                                                     border="0"><?php } elseif ($pagos_online->url->getSort() == "DESC") { ?>
                                                                <img src="phpimages/sortdown.gif" width="10" height="9"
                                                                     border="0"><?php } ?></td>
                                                    </tr>
                                                    </thead>
                                    ...
                                    <tr<?php echo $pagos_online->RowAttributes() ?>>
                                        ...
                                        <?php if ($pagos_online->usuarioid->Visible) { // usuarioid ?>
                                            <td<?php echo $pagos_online->usuarioid->CellAttributes() ?>>
                                                ...
                                                <a name="<?php echo $pagos_online_list->PageObjName . "_row_" . $pagos_online_list->RowCnt ?>"
                                                   id="<?php echo $pagos_online_list->PageObjName . "_row_" . $pagos_online_list->RowCnt ?>"></a>
                                            </td>
                                        <?php } ?>
                                        <?php if ($pagos_online->llave_encripcion->Visible) { // llave_encripcion ?>
