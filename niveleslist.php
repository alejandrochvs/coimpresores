...
?>
<p class="phpmaker ewTitle" style="white-space: nowrap;"><?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $niveles->TableCaption() ?>
...
<?php if ($niveles->idnivel->Visible) { // idnivel ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $niveles->SortUrl($niveles->idnivel) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $niveles->idnivel->FldCaption() ?></td><td style="width: 10px;"><?php if ($niveles->idnivel->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($niveles->idnivel->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($niveles->nombrenivel->Visible) { // nombrenivel ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $niveles->SortUrl($niveles->nombrenivel) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $niveles->nombrenivel->FldCaption() ?></td><td style="width: 10px;"><?php if ($niveles->nombrenivel->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($niveles->nombrenivel->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php
...
<a name="<?php echo $niveles_list->PageObjName . "_row_" . $niveles_list->RowCnt ?>" id="<?php echo $niveles_list->PageObjName . "_row_" . $niveles_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($niveles->nombrenivel->Visible) { // nombrenivel ?>
...
<?php if ($niveles_list->Pager->RecordCount > 0) { ?>
	...
	<?php foreach ($niveles_list->Pager->Items as $PagerItem) { ?>
		<?php if ($PagerItem->Enabled) { ?><a href="<?php echo $niveles_list->PageUrl() ?>start=<?php echo $PagerItem->Start ?>"><?php } ?><b><?php echo $PagerItem->Text ?></b><?php if ($PagerItem->Enabled) { ?></a><?php } ?>&nbsp;
	<?php } ?>
...
<a class="ewGridLink" href="<?php echo $niveles_list->AddUrl ?>"><?php echo $Language->Phrase("AddLink") ?></a>&nbsp;&nbsp;
<?php } ?>
</span>
</div>
<?php } ?>
