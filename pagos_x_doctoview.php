...
<?php } ?>
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $pagos_x_docto->TableCaption() ?>
...
<div<?php echo $pagos_x_docto->iddoctocontable->ViewAttributes() ?>><?php echo $pagos_x_docto->iddoctocontable->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->historial->ViewAttributes() ?>><?php echo $pagos_x_docto->historial->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->tipo_docto->ViewAttributes() ?>><?php echo $pagos_x_docto->tipo_docto->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->consec_docto->ViewAttributes() ?>><?php echo $pagos_x_docto->consec_docto->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->valor->ViewAttributes() ?>><?php echo $pagos_x_docto->valor->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->cia->ViewAttributes() ?>><?php echo $pagos_x_docto->cia->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->nit->ViewAttributes() ?>><?php echo $pagos_x_docto->nit->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->tercero->ViewAttributes() ?>><?php echo $pagos_x_docto->tercero->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->fecha->ViewAttributes() ?>><?php echo $pagos_x_docto->fecha->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->dias_vencidos->ViewAttributes() ?>><?php echo $pagos_x_docto->dias_vencidos->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->estado->ViewAttributes() ?>><?php echo $pagos_x_docto->estado->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->usuario->ViewAttributes() ?>><?php echo $pagos_x_docto->usuario->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->estado_pago->ViewAttributes() ?>><?php echo $pagos_x_docto->estado_pago->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->descripcion->ViewAttributes() ?>><?php echo $pagos_x_docto->descripcion->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->fecha_vencimiento->ViewAttributes() ?>><?php echo $pagos_x_docto->fecha_vencimiento->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $pagos_x_docto->monto_pago->ViewAttributes() ?>><?php echo $pagos_x_docto->monto_pago->ViewValue ?></div></td>
	</tr>
<?php } ?>
</table>
</div>
