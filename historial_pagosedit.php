...
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("Edit") ?>
    &nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $historial_pagos->TableCaption() ?></p>
<p class="phpmaker"><a
            href="<?php echo $historial_pagos->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $historial_pagos_edit->ShowPageHeader(); ?>
<?php
$historial_pagos_edit->ShowMessage();
?>
<form name="fhistorial_pagosedit" id="fhistorial_pagosedit" action="<?php echo ew_CurrentPage() ?>" method="post"
      onsubmit="return historial_pagos_edit.ValidateForm(this);">
    <p>
                    ...
                    <table cellspacing="0" class="ewTable">
                        <?php if ($historial_pagos->idhistorial_pagos->Visible) { // idhistorial_pagos ?>
                            <tr id="r_idhistorial_pagos"<?php echo $historial_pagos->RowAttributes() ?>>
                                ...
                                <td<?php echo $historial_pagos->idhistorial_pagos->CellAttributes() ?>><span
                                            id="el_idhistorial_pagos">
<div<?php echo $historial_pagos->idhistorial_pagos->ViewAttributes() ?>><?php echo $historial_pagos->idhistorial_pagos->EditValue ?></div>
<input type="hidden" name="x_idhistorial_pagos" id="x_idhistorial_pagos"
       value="<?php echo ew_HtmlEncode($historial_pagos->idhistorial_pagos->CurrentValue) ?>">
...
<?php if (!$Security->IsAdmin() && $Security->IsLoggedIn()) { // Non system admin ?>
    ...
    <input type="hidden" name="x_usuario" id="x_usuario"
           value="<?php echo ew_HtmlEncode($historial_pagos->usuario->CurrentValue) ?>">
<?php } else { ?>
...
<?php } ?>
                        ...
                        <?php if ($historial_pagos->tipo_docto->Visible) { // tipo_docto ?>
                            <tr id="r_tipo_docto"<?php echo $historial_pagos->RowAttributes() ?>>
                                ...
                                <td<?php echo $historial_pagos->tipo_docto->CellAttributes() ?>><span
                                            id="el_tipo_docto">
<input type="text" name="x_tipo_docto" id="x_tipo_docto" size="30" maxlength="45"
       value="<?php echo $historial_pagos->tipo_docto->EditValue ?>"<?php echo $historial_pagos->tipo_docto->EditAttributes() ?>>
                        ...
                        <?php if ($historial_pagos->consec_docto->Visible) { // consec_docto ?>
                            <tr id="r_consec_docto"<?php echo $historial_pagos->RowAttributes() ?>>
                                ...
                                <td<?php echo $historial_pagos->consec_docto->CellAttributes() ?>><span
                                            id="el_consec_docto">
<input type="text" name="x_consec_docto" id="x_consec_docto" size="30"
       value="<?php echo $historial_pagos->consec_docto->EditValue ?>"<?php echo $historial_pagos->consec_docto->EditAttributes() ?>>
                        ...
                        <?php if ($historial_pagos->estado_pago->Visible) { // estado_pago ?>
                            <tr id="r_estado_pago"<?php echo $historial_pagos->RowAttributes() ?>>
                                ...
                                <td<?php echo $historial_pagos->estado_pago->CellAttributes() ?>><span
                                            id="el_estado_pago">
<input type="text" name="x_estado_pago" id="x_estado_pago" size="30" maxlength="45"
       value="<?php echo $historial_pagos->estado_pago->EditValue ?>"<?php echo $historial_pagos->estado_pago->EditAttributes() ?>>
...
<input type="text" name="x_ref_venta" id="x_ref_venta" size="30" maxlength="45"
       value="<?php echo $historial_pagos->ref_venta->EditValue ?>"<?php echo $historial_pagos->ref_venta->EditAttributes() ?>>
                        ...
                        <?php if ($historial_pagos->fecha_hora_creacion->Visible) { // fecha_hora_creacion ?>
                            <tr id="r_fecha_hora_creacion"<?php echo $historial_pagos->RowAttributes() ?>>
                                ...
                                <td<?php echo $historial_pagos->fecha_hora_creacion->CellAttributes() ?>><span
                                            id="el_fecha_hora_creacion">
<input type="text" name="x_fecha_hora_creacion" id="x_fecha_hora_creacion"
       value="<?php echo $historial_pagos->fecha_hora_creacion->EditValue ?>"<?php echo $historial_pagos->fecha_hora_creacion->EditAttributes() ?>>
...
<input type="text" name="x_riesgo" id="x_riesgo" size="30" maxlength="45"
       value="<?php echo $historial_pagos->riesgo->EditValue ?>"<?php echo $historial_pagos->riesgo->EditAttributes() ?>>
                        ...
                        <?php if ($historial_pagos->medio_pago->Visible) { // medio_pago ?>
                            <tr id="r_medio_pago"<?php echo $historial_pagos->RowAttributes() ?>>
                                ...
                                <td<?php echo $historial_pagos->medio_pago->CellAttributes() ?>><span
                                            id="el_medio_pago">
<input type="text" name="x_medio_pago" id="x_medio_pago" size="30" maxlength="2"
       value="<?php echo $historial_pagos->medio_pago->EditValue ?>"<?php echo $historial_pagos->medio_pago->EditAttributes() ?>>
                        ...
                        <?php if ($historial_pagos->respuesta_pol->Visible) { // respuesta_pol ?>
                            <tr id="r_respuesta_pol"<?php echo $historial_pagos->RowAttributes() ?>>
                                ...
                                <td<?php echo $historial_pagos->respuesta_pol->CellAttributes() ?>><span
                                            id="el_respuesta_pol">
<input type="text" name="x_respuesta_pol" id="x_respuesta_pol" size="30" maxlength="2"
       value="<?php echo $historial_pagos->respuesta_pol->EditValue ?>"<?php echo $historial_pagos->respuesta_pol->EditAttributes() ?>>
                        ...
                        <?php if ($historial_pagos->monto_pago->Visible) { // monto_pago ?>
                            <tr id="r_monto_pago"<?php echo $historial_pagos->RowAttributes() ?>>
                                ...
                                <td<?php echo $historial_pagos->monto_pago->CellAttributes() ?>><span
                                            id="el_monto_pago">
<input type="text" name="x_monto_pago" id="x_monto_pago" size="30"
       value="<?php echo $historial_pagos->monto_pago->EditValue ?>"<?php echo $historial_pagos->monto_pago->EditAttributes() ?>>
