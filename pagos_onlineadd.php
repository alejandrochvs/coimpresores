...
<p class="phpmaker ewTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $pagos_online->TableCaption() ?></p>
...
?>
<form name="fpagos_onlineadd" id="fpagos_onlineadd" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return pagos_online_add.ValidateForm(this);">
<p>
...
<input type="text" name="x_idpagosonline" id="x_idpagosonline" size="30" value="<?php echo $pagos_online->idpagosonline->EditValue ?>"<?php echo $pagos_online->idpagosonline->EditAttributes() ?>>
