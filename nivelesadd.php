...
?>
<form name="fnivelesadd" id="fnivelesadd" action="<?php echo ew_CurrentPage() ?>" method="post"
      onsubmit="return niveles_add.ValidateForm(this);">
    <p>
...
<input type="text" name="x_idnivel" id="x_idnivel" size="30"
       value="<?php echo $niveles->idnivel->EditValue ?>"<?php echo $niveles->idnivel->EditAttributes() ?>>
...
<input type="text" name="x_nombrenivel" id="x_nombrenivel" size="30" maxlength="80"
       value="<?php echo $niveles->nombrenivel->EditValue ?>"<?php echo $niveles->nombrenivel->EditAttributes() ?>>
                        ...
                        <tr id="rp_permission">
                            ...
                            <td>
                                <label><input type="checkbox" name="x__AllowAdd" id="Add"
                                              value="<?php echo EW_ALLOW_ADD ?>"><?php echo $Language->Phrase("PermissionAddCopy") ?>
                                </label>
                                <label><input type="checkbox" name="x__AllowDelete" id="Delete"
                                              value="<?php echo EW_ALLOW_DELETE ?>"><?php echo $Language->Phrase("PermissionDelete") ?>
                                </label>
                                <label><input type="checkbox" name="x__AllowEdit" id="Edit"
                                              value="<?php echo EW_ALLOW_EDIT ?>"><?php echo $Language->Phrase("PermissionEdit") ?>
                                </label>
                                <?php if (defined("EW_USER_LEVEL_COMPAT")) { ?>
                                    <label><input type="checkbox" name="x__AllowList" id="List"
                                                  value="<?php echo EW_ALLOW_LIST ?>"><?php echo $Language->Phrase("PermissionListSearchView") ?>
                                    </label>
                                <?php } else { ?>
                                    <label><input type="checkbox" name="x__AllowList" id="List"
                                                  value="<?php echo EW_ALLOW_LIST ?>"><?php echo $Language->Phrase("PermissionList") ?>
                                    </label>
                                    <label><input type="checkbox" name="x__AllowView" id="View"
                                                  value="<?php echo EW_ALLOW_VIEW ?>"><?php echo $Language->Phrase("PermissionView") ?>
                                    </label>
                                    <label><input type="checkbox" name="x__AllowSearch" id="Search"
                                                  value="<?php echo EW_ALLOW_SEARCH ?>"><?php echo $Language->Phrase("PermissionSearch") ?>
                                    </label>
                                <?php } ?>
                            </td>
                        </tr>
