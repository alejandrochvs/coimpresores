...
<input type="text" name="x_fecha_hora" id="x_fecha_hora" value="<?php echo $auditoria->fecha_hora->EditValue ?>"<?php echo $auditoria->fecha_hora->EditAttributes() ?>>
...
<input type="text" name="x_campo" id="x_campo" size="30" maxlength="80" value="<?php echo $auditoria->campo->EditValue ?>"<?php echo $auditoria->campo->EditAttributes() ?>>
...
<textarea name="x_valorclave" id="x_valorclave" cols="35" rows="4"<?php echo $auditoria->valorclave->EditAttributes() ?>><?php echo $auditoria->valorclave->EditValue ?></textarea>
...
<textarea name="x_viejovalor" id="x_viejovalor" cols="35" rows="4"<?php echo $auditoria->viejovalor->EditAttributes() ?>><?php echo $auditoria->viejovalor->EditValue ?></textarea>
...
<textarea name="x_nuevovalor" id="x_nuevovalor" cols="35" rows="4"<?php echo $auditoria->nuevovalor->EditAttributes() ?>><?php echo $auditoria->nuevovalor->EditValue ?></textarea>
...
class cauditoria_edit {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// fecha_hora
			$auditoria->fecha_hora->SetDbValueDef($rsnew, ew_UnFormatDateTime($auditoria->fecha_hora->CurrentValue, 11), ew_CurrentDate(), $auditoria->fecha_hora->ReadOnly);
			...
			// campo
			$auditoria->campo->SetDbValueDef($rsnew, $auditoria->campo->CurrentValue, NULL, $auditoria->campo->ReadOnly);

			// valorclave
			$auditoria->valorclave->SetDbValueDef($rsnew, $auditoria->valorclave->CurrentValue, NULL, $auditoria->valorclave->ReadOnly);

			// viejovalor
			$auditoria->viejovalor->SetDbValueDef($rsnew, $auditoria->viejovalor->CurrentValue, NULL, $auditoria->viejovalor->ReadOnly);

			// nuevovalor
			$auditoria->nuevovalor->SetDbValueDef($rsnew, $auditoria->nuevovalor->CurrentValue, NULL, $auditoria->nuevovalor->ReadOnly);
