...
<?php echo $auditoria->TableCustomInnerHtml ?>
	...
	<tr class="ewTableHeader">
		...
		<td valign="top"><?php echo $auditoria->fecha_hora->FldCaption() ?></td>
		...
		<td valign="top"><?php echo $auditoria->campo->FldCaption() ?></td>
	</tr>
	</thead>
	<tbody>
<?php
...
<div<?php echo $auditoria->fecha_hora->ViewAttributes() ?>><?php echo $auditoria->fecha_hora->ListViewValue() ?></div></td>
...
<div<?php echo $auditoria->campo->ViewAttributes() ?>><?php echo $auditoria->campo->ListViewValue() ?></div></td>
	</tr>
<?php
